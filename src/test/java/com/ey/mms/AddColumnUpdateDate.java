...
@CucumberOptions(features = "src/test/resources/features/Voiding/AddColumnUpdateDate.feature")
public class AddColumnUpdateDate {

	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Add column update \n");
