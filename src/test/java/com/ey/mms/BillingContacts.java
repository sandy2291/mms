...
@CucumberOptions(features = "src/test/resources/features/BillingContacts/billing_contacts.feature")
public class BillingContacts {
	...
	public static void setup() {
		...
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "billingContactsBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "billingContactsMgmtBackup");
