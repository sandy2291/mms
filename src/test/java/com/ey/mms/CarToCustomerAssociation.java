...
@CucumberOptions(features = "src/test/resources/features/CarAssociation/car_to_customer_association.feature")
public class CarToCustomerAssociation {
	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Car to customer association \n");
		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");

		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "CarToCustomerAssociationBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "CarToCustomerAssociationMgmtBackup");
