...
@CucumberOptions(features = "src/test/resources/features/CombinedBilling/combined_billing.feature")
public class CombinedBilling {
	@BeforeClass
	public static void setup() {
		System.out.println("I'm in CB \n");

		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "m2Backup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "m2MgmtBackup");
