...
@CucumberOptions(features = "src/test/resources/features/System/company_information.feature")
public class CompanyInformation {
	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Company Info \n");
		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "companyInfoBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "companyInfoMgmtBackup");
