...
@CucumberOptions(features = "src/test/resources/features/Exception/exception_tracking.feature")
public class ExceptionTracking {
	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Exception Tracking \n");

		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "exceptionTrackingBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "exceptionTrackingMgmtBackup");
