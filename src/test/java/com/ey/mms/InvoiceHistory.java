...
@CucumberOptions(features = "src/test/resources/features/Billing/invoice_history.feature")
public class InvoiceHistory {
	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Invoice History");

		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "invoiceHistoryBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "invoiceHistoryMgmtBackup");
