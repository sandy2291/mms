...
@CucumberOptions(features = "src/test/resources/features/Billing/invoicing.feature")
public class Invoicing {
	...
	public static void setup() {
		...
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "invoicingBackup");
