...
@CucumberOptions(features = "src/test/resources/features/Leases/lease_assignment.feature")
public class LeaseAssignment {
	@BeforeClass
	public static void setup() {
		System.out.println("I'm in lease assignment");

		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "leaseAssignmentBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "leaseAssignmentMgmtBackup");
