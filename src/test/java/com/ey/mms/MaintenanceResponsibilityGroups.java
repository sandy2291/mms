...
@CucumberOptions(features = "src/test/resources/features/Leases/maintenance_responsibility_groups.feature")
public class MaintenanceResponsibilityGroups {

	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Maintenance Responsibility Groups \n");
		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "maintenanceResponsibilityGroupsBackup");
		...
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename,
				"maintenanceResponsibilityGroupsMgmtBackup");
