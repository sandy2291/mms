...
@CucumberOptions(features="src/test/resources/features/Rejection/paid_and_finalized_invoices_validation.feature")
public class PaidAndFinalizedInvoicesValidation{

	@BeforeClass
	public static void setup() {
		System.out.println("You are in Rejection Tracking \n");
