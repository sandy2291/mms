...
@CucumberOptions(features = "src/test/resources/features/Voiding/remove_from_combined_billing_not_allowed.feature")
public class RemoveFromCombinedBillingnotAllowed {

	@BeforeClass
	public static void setup() {
		System.out.println("I'm in remove from CB of not voided \n");

		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "RemoveFromCombinedBillingnotallowedBackup");
		...
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename,
				"RemoveFromCombinedBillingnotallowedMgmtBackup");
