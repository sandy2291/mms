...
@CucumberOptions(features = "src/test/resources/features/Repairs/repair_details.feature")
public class RepairDetails {
	@BeforeClass
	public static void setup() {
		System.out.println("I'm in repair details \n");
		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "repairDetailsBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "repairDetailsMgmtBackup");
