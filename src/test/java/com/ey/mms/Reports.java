...
@CucumberOptions(features = "src/test/resources/features/Reports/report_history.feature")
public class Reports {
	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Report History");

		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "reportHistoryBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "reportHistoryMgmtBackup");
