...
@CucumberOptions(features = "src/test/resources/features/Voiding/send_to_combined_billing_of_voided.feature")
public class SendToCombinedBillingVoided {

	@BeforeClass
	public static void setup() {
		System.out.println("I'm in send to CB voided \n");

		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "SendToCombinedBillingOfVoidedBackup");
