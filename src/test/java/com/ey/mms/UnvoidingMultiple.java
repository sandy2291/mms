...
@CucumberOptions(features = "src/test/resources/features/Voiding/unvoiding_multiple.feature")
public class UnvoidingMultiple {

	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Multiple Invoice Voiding validation \n");

		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");

		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "UnvoidingMultipleBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "UnvoidingMultipleMgmtBackup");
