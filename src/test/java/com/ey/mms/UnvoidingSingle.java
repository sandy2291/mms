...
@CucumberOptions(features = "src/test/resources/features/Voiding/unvoiding_single.feature")
public class UnvoidingSingle {

	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Unvoiding single \n");

		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");

		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "UnvoidingSingleBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "UnvoidingSingleMgmtBackup");
