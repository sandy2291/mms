...
@CucumberOptions(features = "src/test/resources/features/System/user_manager.feature")
public class UserManager {
	@BeforeClass
	public static void setup() {
		System.out.println("I'm in User manager \n");

		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "userMgrBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "userMgrMgmtBackup");
