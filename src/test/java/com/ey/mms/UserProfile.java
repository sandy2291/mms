...
@CucumberOptions(features = "src/test/resources/features/System/user_profile.feature")
public class UserProfile {

	@BeforeClass
	public static void setup() {
		System.out.println("I'm in User Profile \n");
		String dbbackupfilename = new PropertyReader().readProperty("dbbackup");
		String dbName = new PropertyReader().readProperty("dbName");
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "userProfileBackup");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "userProfileMgmtBackup");
