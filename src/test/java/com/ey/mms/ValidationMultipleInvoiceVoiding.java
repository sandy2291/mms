...
@CucumberOptions(features = "src/test/resources/features/Voiding/validation_multiple_invoice_voiding.feature")
public class ValidationMultipleInvoiceVoiding {
	...
	public static void setup() {
		...
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "MultipleInvoiceVoidingValidationBackup");
		...
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename,
				"MultipleInvoiceVoidingValidationMgmtBackup");
