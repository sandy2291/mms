...
@CucumberOptions(features = "src/test/resources/features/Voiding/validation_of_invoice_creation.feature")
public class ValidationOfInvoiceCreation {

	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Validation of Invoice Creation \n");
		...
		String backup = EY_FW_Utility.getConfigProperty(dbbackupfilename, "ValidationOfInvoiceCreation");
		String dbNameMgmt = new PropertyReader().readProperty("dbNameMgmt");
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "ValidationOfInvoiceCreationMgmtBackup");
