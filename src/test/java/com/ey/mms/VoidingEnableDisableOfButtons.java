...
@CucumberOptions(features = "src/test/resources/features/Voiding/enable_disable_of_button.feature")
public class VoidingEnableDisableOfButtons {
	@BeforeClass
	public static void setup() {
		System.out.println("I'm in Voiding Enable and Disable button");
		...
		String backupMgmt = EY_FW_Utility.getConfigProperty(dbbackupfilename, "EnableDisableMgmtBackup");
		...
		if (EY_FW_Utility.restoreDB(dbNameMgmt, backupMgmt) == 0) {
