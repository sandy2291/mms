...
public class MMS_ExceptionReviewInvoiceList {
	...
	//
	public static final String FROMINVOICENUMBER = "id_ExceptionInvoiceFilterModel_InvoiceNumber_Start";
	public static final String TOINVOICENUMBER = "id_ExceptionInvoiceFilterModel_InvoiceNumber_End";
	public static final String EXCEPTIONSTATUS = "id_ExceptionInvoiceFilterModel_ExceptionStatus";
	public static final String GENERATEREJECTIONLETTERBUTTON = "xpath_.//*[@id='notification-main']/div[2]/div/section/div/button";
	public static final String ERRORPOPUP = "xpath_.//*[@id='modal-popup']/div[2]/ul/li";
	public static final String HASEXCEPTION = "id_ExceptionFilter_HasExceptions";
	public static final String PAIDINVOICENUMBER = "xpath_//*[@id='DataTables_Table_0']/tbody/tr[1]/td[1]/input";
